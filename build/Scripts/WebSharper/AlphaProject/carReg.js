...
import { Create as Create_2, Lazy, MarkResizable, SetOptional, GetOptional, CreateFuncWithArgs, DeleteEmptyFields } from "../WebSharper.Core.JavaScript/Runtime.js"
...
export function RegisterCar(){
  ...
  const serverRespons=_c.Create_1("");
  setTimeout(() => {
...
function userEmail(){
  return _c_1.userEmail;
}
function password(){
  return _c_1.password;
}
...
let _c_1=Lazy((_i) => class $StartupCode_Client {
  ...
  static userEmail;
  static {
    this.userEmail=_c.Create_1("");
    this.password=_c.Create_1("");
  }
});
...
function DecodeList(decEl){
  return() =>(a) => {
    const e=decEl();
    return init_2(length(a), (i) => e(get(a, i)));
  };
}
