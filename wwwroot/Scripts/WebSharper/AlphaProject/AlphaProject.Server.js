...
import { DecodeJson_RepairStatus, DecodeJson_FailureCost, EncodeJson_CarJoinedData, DecodeJson_CarJoinedData, EncodeJson_UserData } from "./$Generated.js"
...
export function LogingInToDatabase(userPassword, userEmail){
  return Bind((new AjaxRemotingProvider()).Async("Server/LogingInToDatabase", [userPassword, userEmail]), (o) => Return(o));
}
...
export function CurrentUser(password, email){
  return Bind((new AjaxRemotingProvider()).Async("Server/CurrentUser", [password, email]), (o) => Return(o));
}
